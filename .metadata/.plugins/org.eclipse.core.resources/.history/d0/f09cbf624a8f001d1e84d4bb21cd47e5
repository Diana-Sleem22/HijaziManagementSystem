...
public class LandingPageController implements Initializable {
    ...
    @FXML
    void CategoryPage(javafx.event.ActionEvent actionEvent) throws IOException {
		...
		categoryBtn.setStyle("-fx-background-color: #ffffff; -fx-text-fill:black; ");
    }
	@FXML
...
//	}
	...
	void updateUSDRate(ActionEvent event) throws IOException, ParseException {
		String usd=usdRateTextValue.getText();
		if(usd.isEmpty()) {
